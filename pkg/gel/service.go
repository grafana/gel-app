...
func init() {
	registry.RegisterService(&GelService{})
}

// GelService is service representation for GEL.
type GelService struct {
	Bus             bus.Bus                  `inject:""`
	RouterRegister  routing.RouteRegister    `inject:""`
...
func (s *GelService) Pipeline(c *models.ReqContext, req GelAppReq) api.Response {
